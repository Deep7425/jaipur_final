...
@section('title', 'Login - Jaipur Jazbaa')

@section('description', 'Sign in to your Jaipur Jazbaa account to access your orders, wishlist, and personalized shopping experience.')
      ...
      <div class="login-form">
        <form method="POST" action="#" name="login-form" class="needs-validation" novalidate="">
          ...
          <div class="customer-option mt-4 text-center">
            ...
            <a href="{{url('/register')}}" class="btn-text js-show-register">Create Account</a> | <a href="{{url('/my-account')}}"
