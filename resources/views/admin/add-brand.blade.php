...
@section('title', 'Add Brand - Jaipur Jazbaa Admin')

@section('description', 'Add new brand to the system')
...
<!-- new-brand -->
<div class="wg-box">
    <form class="form-new-product form-style-1" action="{{url('/admin/brands')}}" method="POST"
