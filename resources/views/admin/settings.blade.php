...
@section('title', 'Settings - Jaipur Jazbaa Admin')

@section('description', 'Admin settings and configuration')
    ...
    <div class="col-lg-12">
        <div class="page-content my-account__edit">
            <div class="my-account__edit-form">
                <form name="account_edit_form" action="{{url('/admin/settings')}}" method="POST"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Full Name"
                            name="name" tabindex="0" value="{{old('name', 'Admin User')}}" aria-required="true"
                            required="">
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Mobile Number"
                            name="mobile" tabindex="0" value="{{old('mobile', '+91 9876543210')}}" aria-required="true"
                            required="">
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="email" placeholder="Email Address"
                            name="email" tabindex="0" value="{{old('email', 'admin@jaipurjazbaa.com')}}" aria-required="true"
                            required="">
                    </fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="my-3">
                                <button type="submit"
                                    class="btn btn-primary tf-button w208">Save Changes</button>
                            </div>
                        </div>
                    </div>
                </form>
