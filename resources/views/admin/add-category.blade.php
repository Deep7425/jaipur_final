...
@section('title', 'Add Category - Jaipur Jazbaa Admin')

@section('description', 'Add new category to organize products')
...
<!-- new-category -->
<div class="wg-box">
    <form class="form-new-product form-style-1" id="categoryForm" action="{{url('/admin/add-category')}}" method="POST"
