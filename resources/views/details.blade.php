            ...
            <div class="product-single__image">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                    @if($data->image)
                    <?php $images = json_decode($data->image); ?>
                    @foreach($images as $image)
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{url('public/assets/images/products/'.$image)}}" width="674"
                      height="674" alt="" />
                    <a data-fancybox="gallery" href="{{url('public/assets/images/products/'.$image)}}" data-bs-toggle="tooltip"
            ...
            <div class="product-single__thumbnail">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    @foreach($images as $image)
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{url('public/assets/images/products/'.$image)}}" width="104" height="104" alt="" />
                    </div>
                    @endforeach
                    @endif
      ...
      <div id="related_products" class="position-relative">
        <div class="swiper-container js-swiper-slider" data-settings='{
          ...
          <div class="swiper-wrapper">
            ...
            <?php  $images = json_decode($product->image, true); // convert JSON to array
               $firstImage = $images[0] ?? $product->image;   ?>
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="details.html">
                  <img loading="lazy" src="{{url('public/assets/images/products/'. $firstImage )}}" width="330" height="400"
